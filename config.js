System.config({
  ...
  map: {
    ...
    "remark": "npm:remark@3.2.2",
    "remark-html": "npm:remark-html@2.0.2",
    "unist-util-visit": "npm:unist-util-visit@1.0.0",
    ...
    "npm:attach-ware@1.0.0": {
      "unherit": "npm:unherit@1.0.4"
    },
    "npm:aws-sign2@0.6.0": {
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "url": "github:jspm/nodelibs-url@0.1.0"
    ...
    "npm:character-entities-html4@1.0.0": {
      "systemjs-json": "github:systemjs/plugin-json@0.1.0"
    },
    "npm:character-entities-legacy@1.0.0": {
      "systemjs-json": "github:systemjs/plugin-json@0.1.0"
    },
    "npm:character-entities@1.0.0": {
      "systemjs-json": "github:systemjs/plugin-json@0.1.0"
    },
    "npm:character-reference-invalid@1.0.0": {
      "systemjs-json": "github:systemjs/plugin-json@0.1.0"
    },
    "npm:chokidar@1.4.2": {
    ...
    "npm:npm-prefix@1.1.1": {
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "rc": "npm:rc@1.1.6",
      "untildify": "npm:untildify@2.1.0"
    },
    "npm:npmlog@2.0.1": {
      "ansi": "npm:ansi@0.3.1",
    ...
    "npm:parse-entities@1.0.2": {
      "character-entities": "npm:character-entities@1.0.0",
      "character-entities-legacy": "npm:character-entities-legacy@1.0.0",
      "character-reference-invalid": "npm:character-reference-invalid@1.0.0"
    },
    ...
    "npm:remark-html@2.0.2": {
      "collapse-white-space": "npm:collapse-white-space@1.0.0",
      "detab": "npm:detab@1.0.2",
      "normalize-uri": "npm:normalize-uri@1.0.0",
      "object-assign": "npm:object-assign@4.0.1",
      "trim": "npm:trim@0.0.1",
      "trim-lines": "npm:trim-lines@1.0.0",
      "unist-util-visit": "npm:unist-util-visit@1.0.0"
    },
    "npm:remark@3.2.2": {
      "camelcase": "npm:camelcase@2.1.0",
      "ccount": "npm:ccount@1.0.0",
      "chalk": "npm:chalk@1.1.1",
      ...
      "events": "github:jspm/nodelibs-events@0.1.1",
      "extend.js": "npm:extend.js@0.0.2",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "glob": "npm:glob@6.0.4",
      "globby": "npm:globby@4.0.0",
      "he": "npm:he@0.5.0",
      "log-update": "npm:log-update@1.0.2",
      "longest-streak": "npm:longest-streak@1.0.0",
      "markdown-table": "npm:markdown-table@0.4.0",
      "minimatch": "npm:minimatch@3.0.0",
      "npm-prefix": "npm:npm-prefix@1.1.1",
      "parse-entities": "npm:parse-entities@1.0.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "repeat-string": "npm:repeat-string@1.5.2",
      "stringify-entities": "npm:stringify-entities@1.0.1",
      "systemjs-json": "github:systemjs/plugin-json@0.1.0",
      "to-vfile": "npm:to-vfile@1.0.0",
      "trim": "npm:trim@0.0.1",
      "trim-trailing-lines": "npm:trim-trailing-lines@1.0.0",
      "unified": "npm:unified@2.1.4",
      "user-home": "npm:user-home@2.0.0",
      "util": "github:jspm/nodelibs-util@0.1.0",
      "vfile": "npm:vfile@1.3.1",
      "vfile-find-down": "npm:vfile-find-down@1.0.0",
      "vfile-find-up": "npm:vfile-find-up@1.0.0",
      "vfile-reporter": "npm:vfile-reporter@1.5.0",
      "ware": "npm:ware@1.3.0"
    },
    "npm:request@2.67.0": {
    ...
    "npm:stringify-entities@1.0.1": {
      "character-entities-html4": "npm:character-entities-html4@1.0.0"
    },
    ...
    "npm:unified@2.1.4": {
      "attach-ware": "npm:attach-ware@1.0.0",
      "bail": "npm:bail@1.0.0",
      "extend": "npm:extend@3.0.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "unherit": "npm:unherit@1.0.4",
    ...
    "npm:vfile-find-down@1.0.0": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "to-vfile": "npm:to-vfile@1.0.0"
    },
    "npm:vfile-find-up@1.0.0": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "to-vfile": "npm:to-vfile@1.0.0"
    },
    "npm:vfile-reporter@1.5.0": {
      "chalk": "npm:chalk@1.1.1",
      ...
      "vfile-sort": "npm:vfile-sort@1.0.0"
    },
    "npm:vfile@1.3.1": {
      "process": "github:jspm/nodelibs-process@0.1.2"
    },
